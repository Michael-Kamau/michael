<template>
  <div class="grid grid-cols-1 md:grid-cols-3 p-8">
    <div class="hiddden md:block p-2">
      <p class="text-2xl font-light text-gray-600">Reach out!</p>
      <p class="text-lg font-thin text-gray-700">
        You can fill out the form in case you have any enquiries or comments. I
        will then get back to you on the provided email address. Looking forward
        to hearing from you.
      </p>
      <div class="shadow-md rounded-md bg-white w-80 md:rotate-12 mt-8">
        <svg
        ...
        >
          ...
          <path
            ...
            fill="#ccc"
          />
          <circle cx="659.19545" cy="344.46999" r="34" fill="#095982" />
          <path
            ...
            fill="#3f3d56"
          />
          <circle cx="947.55373" cy="297.46999" r="23" fill="#095982" />
          <path
          ...
          <path
            ...
            fill="#3f3d56"
          />
          <circle cx="868.77037" cy="564.14065" r="6" fill="#095982" />
          <path
          ...
          <path
            ...
            fill="#2f2e41"
          />
          <circle cx="354.12853" cy="79.9818" r="29.51181" fill="#095982" />
          <path
